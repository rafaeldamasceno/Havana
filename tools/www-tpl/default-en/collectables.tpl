...
{% if hasCollectable %}
		<div id="collectibles-current-img" style="background-image: url({{ site.sitePath }}:5001/?sprite={{ collectableSprite }}&direction=2&canvas=transparent)"></div>
...
{% for entry in collectablesShowroom %}
	...
	<div class="collectibles-prodimg" style="background-image: url(http://ayylmao.hopto.org:5001/?sprite={{ entry.getSprite() }}&direction=2&icon=1&canvas=transparent);"></div>
	<h4>{{ entry.getName() }}</h4>
