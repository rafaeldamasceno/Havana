    ...
    public static void get(WebConnection webConnection) {
        ...
        if (webConnection.get().contains("username") && webConnection.get().contains("password")) {
            ...
            if (!hasError) {
                ...
                jsonDetails.shockwaveDcr = GameConfiguration.getInstance().getString("loader.dcr");
                jsonDetails.shockwaveVariables = GameConfiguration.getInstance().getString("loader.external.variables");
                jsonDetails.shockwaveTexts = GameConfiguration.getInstance().getString("loader.external.texts");
